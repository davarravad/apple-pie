        ...
        <div class="col-xs-12">
            ...
            <form role="form" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input id="website" type="website" class="form-control" name="website" placeholder="Enter your website" value="<?php echo DIR.$data['profile']->website; ?>">
                </div>
...
<!--                    <img alt="User Pic" src="--><?php //echo DIR.'images/profile/'.$data['profile']->userImage; ?><!--" class="img-circle img-responsive">-->
                ...
                <div class="form-group">
                    ...
                    <textarea id="aboutMe"  class="form-control" name="aboutMe" placeholder="Enter Profile" rows="5"><?php echo DIR.$data['profile']->aboutme; ?></textarea>
                </div>
